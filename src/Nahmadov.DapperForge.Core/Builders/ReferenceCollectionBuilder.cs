...
/// <summary>
/// Builder for configuring the FK side of a one-to-many relationship after WithMany().
/// </summary>
    ...
    where TRelated : class
{
    ...
    internal ReferenceCollectionBuilder(RelationshipConfig relationshipConfig)
    {
    ...
    public ReferenceCollectionBuilder<TEntity, TRelated> HasForeignKey(
    ...
    /// <returns>This builder for method chaining.</returns>
    public ReferenceCollectionBuilder<TEntity, TRelated> HasPrincipalKey(
